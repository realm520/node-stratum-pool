...
//     }
    ...
    if (rpcData.default_root_state_hash) {
        let outputs = rpcData.coinbase.data.substr(106, rpcData.coinbase.data.length-114);
        return Buffer.from(outputs, 'hex', 53)
    }
...
exports.CreateGeneration = function(rpcData, publicKey, extraNoncePlaceholder, reward, txMessages, recipients){
    ...
    var p1 = Buffer.concat([
        ...
        txTimestamp,
        util.varIntBuffer(0),   // marker
        util.varIntBuffer(1),   // flag
        //transaction input
